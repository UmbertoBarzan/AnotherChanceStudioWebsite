  ...
  return (
    <Border position="left" className={clsx("pl-8", className)}>
      <figure className="text-sm">
        <blockquote className="text-neutral-600 [&>*]:relative [&>:first-child]:before:absolute [&>:first-child]:before:right-full [&>:first-child]:before:content-['\\201C'] [&>:last-child]:after:content-['\\201D']">
          {typeof children === "string" ? <p>{children}</p> : children}
        </blockquote>
